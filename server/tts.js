...
// Voice defaults per language. Reverted to Samantha / Tingting (both
// female) to match the Haru avatar. Override with IRIS_VOICE_EN /
// IRIS_VOICE_ZH env vars if you want a different voice.
const VOICE_BY_LANG = {
  zh: process.env.IRIS_VOICE_ZH || "Tingting",
  "zh-cn": process.env.IRIS_VOICE_ZH || "Tingting",
  "zh-tw": process.env.IRIS_VOICE_ZH || "Meijia",
  en: process.env.IRIS_VOICE_EN || "Samantha",
  "en-us": process.env.IRIS_VOICE_EN || "Samantha",
